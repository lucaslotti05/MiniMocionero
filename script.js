const boton_esp = document.getElementById("botonEsp");
const boton_anglo = document.getElementById("botonAnglo");
...
boton_esp.addEventListener("click", function(){ //El evento es que cuando se clickee en el boton hace la funcion genérica
...
boton_anglo.addEventListener("click", function(){ //El evento es que cuando se clickee en el boton hace la funcion genérica
    fetch("eng.csv") //pilla los datos
        .then(function(respuesta){ //los pasa a la funcion generica, el resultado de antes es la "respuesta"
            return respuesta.text(); //convierte el contenido a texto en plano
        })
        .then(function(texto){
